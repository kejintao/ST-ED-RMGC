...
from keras.layers import Dense, Activation, Dropout, Lambda, Flatten, Reshape
...
def run_model():
    ...
    output = MultiGraphCNN(NETWORK_STRUCTURE_E[0], num_filters, activation=ACTIVATION,
    ...
    # encoder = Model(inputs=[X_input, graph_conv_filters_input], outputs=latent, name='encoder')
    ...
    save_file_name = CITY + "_" + str(SAMPLE_CASE) + "\\multi_graph_cnn_ed---" + str(int(LR_RATE * 10000)) + "-"
