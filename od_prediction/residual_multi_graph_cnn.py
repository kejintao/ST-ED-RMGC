...
from keras.layers import Dense, Activation, Dropout, Lambda, Add, BatchNormalization
...
def run_model():
    ...
    units = [int(NETWORK_STRUCTURE[0] / 4), int(NETWORK_STRUCTURE[0] / 4), NETWORK_STRUCTURE[0]]
    ...
    output = MultiGraphCNN(train_y.shape[-1], num_filters, activation="linear",
    ...
    save_file_name = CITY + "_" + str(SAMPLE_CASE) + "\\residual_multi_graph_cnn---" + str(int(LR_RATE * 10000)) + "-"
